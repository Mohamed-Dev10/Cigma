...
public static void main(String[] args) {
	...
	Set<Client> lc= new HashSet<Client>();
	lc.add(new Client(1, "Oussama"));
	lc.add(new Client(1, "Abdessadeq"));
	lc.add(new Client(1, "Ghita"));
    ...
    s4.add(new Client(1,"mohamed"));
    s4.add(new Client(3,"samir"));
    s4.add(new Client(2,"salma"));
    s4.add(new Client(2,"ibtihal"));
    s4.add(new Client(4,"Fatima"));
    s4.add(new Client(2,"zakaria"));
